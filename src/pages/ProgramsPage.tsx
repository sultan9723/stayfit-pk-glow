...
import { useScrollToHash } from "@/hooks/useScrollToHash"; // 👈 new import

const ProgramsPage = () => {
  useScrollToHash(); // 👈 enables smooth scroll for #hash links
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore our comprehensive fitness programs including strength training, cardio workouts, MMA, and nutrition coaching at StayFit."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-very-dark-brown pt-20">
        ...
        <section
          ...
          className="py-8 lg:py-16 bg-gradient-to-b from-very-dark-brown to-navy-primary"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-warm-beige max-w-4xl mx-auto leading-relaxed">
                Discover our comprehensive range of fitness programs designed by experts to help
        ...
        <section
          ...
          className="py-8 lg:py-12 bg-navy-primary"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
            ...
            >
              ...
              <p className="text-warm-beige max-w-2xl mx-auto">
                Search and filter our programs by level to find the perfect match for your goals.
              </p>
            </div>
        ...
        <section
          ...
          className="py-8 lg:py-16 bg-very-dark-brown"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div
              className={`text-center mb-16 ${
                programsVisible ? "fade-in-up animate" : "fade-in-up"
              }`}
            >
        ...
        <section
          ...
          className="py-8 lg:py-16 bg-gradient-to-r from-very-dark-brown to-navy-primary"
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className={`${ctaVisible ? "fade-in-up animate" : "fade-in-up"}`}>
              ...
              <p className="text-xl text-warm-beige mb-8 leading-relaxed">
                Join our programs today and take the first step toward your goals.
              </p>
              {showButtons && (
