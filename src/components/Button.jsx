...
const Button = React.forwardRef(({
  ...
  const baseClasses =
    ...
    "focus-visible:ring-2 focus-visible:ring-bronze-primary focus-visible:ring-offset-2 " +
  ...
  const variants = {
    ...
    secondary:
      "bg-warm-beige text-dark-coffee rounded-lg shadow-elegant " +
      "hover:bg-sandstone hover:text-black-coffee hover:scale-105",
